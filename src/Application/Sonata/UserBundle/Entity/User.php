...
use JS\FosAuthBundle\Entity\AuthCode;
use JS\FosAuthBundle\Entity\RefreshToken;
use JS\FosAuthBundle\Entity\AccessToken;
...
class User extends BaseUser
{
    ...
    /**                                                 
     * @ORM\OneToMany(targetEntity="JS\FosAuthBundle\Entity\AccessToken", mappedBy="User")
     */                                                 
    protected $accessToken;

    /**                                                 
     * @ORM\OneToMany(targetEntity="JS\FosAuthBundle\Entity\AuthCode", mappedBy="User")
     */                                                 
    protected $authCode;

    /**                                                 
     * @ORM\OneToMany(targetEntity="JS\FosAuthBundle\Entity\RefreshToken", mappedBy="User")
     */                                                 
